...
- [[requirement_argocd]] <<requirement_argocd,argocd>> (>= 4, < 5.0.0)
...
- [[provider_argocd]] <<provider_argocd,argocd>> (>= 4, < 5.0.0)
...
- https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/federated_identity_credential[azurerm_federated_identity_credential.this] (resource)
...
==== [[input_workload_identities]] <<input_workload_identities,workload_identities>>
